...
public class DownloadImageService extends IntentService {
    ...
    public static Intent makeIntent(Context context,
        ...
        // external storage.
        return new Intent(context, DownloadImageService.class)
            .setData(url)
            .putExtra(REQUEST_CODE, requestCode)
            .putExtra(MESSENGER, new Messenger(downloadHandler))
            .putExtra(DIRECTORY_PATHNAME, directoryPathname);
    }
    ...
    public static String getImagePathname(Bundle data) {
        ...
        return data.getParcelable(IMAGE_PATHNAME).toString();
    }
    ...
    private Message makeReplyMessage(Uri pathToImageFile,
        ...
        // @@ TODO -- you fill in here.
        b.putParcelable(IMAGE_PATHNAME, pathToImageFile);
