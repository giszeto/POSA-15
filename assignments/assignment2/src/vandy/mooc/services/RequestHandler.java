...
class RequestHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        final Messenger replyMessager = requestMessage.getMessenger();
        ...
        final Runnable downloadImageAndReply = 
            new Runnable() {
                ...
                public void run() {
                    ...
                    // TODO -- you fill in here.
                    final Uri pathToFile =
                        Utils.downloadImage(mService.get(), url, directoryPathname);
                    Log.d(TAG, "Downloaded image with url: " + url.toString() + " and pathname: " + directoryPathname);

                    if (pathToFile != null) {Log.d(TAG, "pathToFile: " + pathToFile.toString());}
                    // Send the path to the image file, url, and
                    // requestCode back to the Activity via the
                    // replyMessenger.
                    // TODO -- you fill in here.
                    sendPath(replyMessager, pathToFile, url, requestCode);
                }
            };
